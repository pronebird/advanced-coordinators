...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(
        ...
        appCoordinator?.mount(into: window!)
    }
    ...
    func windowScene(
        ...
        appCoordinator?.handleTraitCollectionChange(
    ...
    func sceneDidBecomeActive(_ scene: UIScene) {
        ...
        // Use this method to restart any tasks that were paused (or not yet started) when the scene
        // was inactive.
    }
