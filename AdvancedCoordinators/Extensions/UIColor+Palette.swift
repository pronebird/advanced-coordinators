...
extension UIColor {
    ...
    enum MainSplitView {
        static let dividerColor = UIColor.secondarySystemBackground
    }
    ...
    enum HeaderBar {
        ...
        static let dividerColor = UIColor.secondarySystemBackground
        static let brandNameColor = UIColor.darkText
        static let buttonColor = UIColor.successColor
        static let disabledButtonColor = UIColor.darkText.withAlphaComponent(0.5)
    }
